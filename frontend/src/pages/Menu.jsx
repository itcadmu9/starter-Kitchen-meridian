...
export default function Menu() {
  ...
  return <div className="public-page">
    <header className="public-header"><strong className="brand">Meridian Kitchens</strong><nav><Link to="/menu">Menu</Link><Link className="corner-login" to="/login">Staff / Manager login</Link></nav></header>
